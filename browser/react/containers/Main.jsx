...
export default class Main extends React.Component {
  ...
  render() {
    const  { albums, selectedAlbum, selectedSong, isPlaying, progress, artists } = this.state;
    return (
      <div id="main" className="container-fluid">
        <Sidebar/>
        <div className="col-xs-10">
          <Switch>
            <Route path="/artists/:id" render={({match}) => <SingleArtist selectArtist={this.selectArtist} artistId={match.params.id}/>}/>
